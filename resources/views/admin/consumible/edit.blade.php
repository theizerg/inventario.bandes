      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <form role="form" id="main-form" autocomplete="off">
            <input type="hidden" id="_url" value="{{ url('consumibles', [$equipo->encode_id]) }}">
            ...
            <div class="card-body">
              <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" style="font-size: 15px;" id="tipo_equipo_consumible" name="tipo_equipo_consumible" value="{{$equipo->tipo_equipo_consumible}} " placeholder="Ingrese el tipo de equipo consumible">
