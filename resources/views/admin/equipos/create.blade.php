      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <form role="form" id="main-form" autocomplete="off">
            <input type="hidden" id="_url" value="{{ url('equipos') }}">
            ...
            <div class="card-body">
              <div class="form-group"> 
                  ...
                  <select class="form-control select2" style="width: 100%;" name="tipo_equipo_id">
                   ...
                   @foreach($tipo as $equipo)
                  <option value="{{$equipo->id}}">{{$equipo->nb_nombre  }} </option>
                  @endforeach
                  </select>
                </div>
              <div class="form-group">
...
@push('scripts')
    ...
    <script src="{{ asset('js/admin/equipos/create.js') }}"></script>
@endpush
