          ...
          <div class="card-header blue-gradient-dark text-white outline-primary ">
             ...
             <div class="card-body">
                <ul class="list-inline">
                             ...
                             <label>Tipo de asignación</label>
                               ...
                               <div class="input-group">
                                 <select id="select_tipo_cliente" class="form-control " name="tipo_de_asignacion">
                                  ...
                                  <option value="consumibles">Equipos consumibles</option>
                            </select>
                         </div>
                     </div>
                   </div>
                 ...
                 <div class="row">
                     <div class="col-sm-4">
                       <div class="form-group form-consumibles">
                         <label>Equipos</label>
                           <div class="input-group">
                            <select id="select_tipo_cliente" class="form-control select2" name="equipo_id">  
                            <option value="0">Seleccione</option>
                            @foreach($consumibles as $equipo)
                              <option value="{{$equipo->id}}">{{$equipo->tipo_equipo_consumible}} | {{$equipo->nb_marca}} | {{$equipo->nb_modelo}} </option>
                              @endforeach
                            </select>
                         </div>
                        </div>
                     ...
                     <div class="col-sm-4">
                      ...
                      <div class="col-sm-12">
                       ...
                       <div class="col-sm-6 form-consumibles">
